...
namespace proyectoBD.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public ProveedoresController(ProyectoBdContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,ApellidoPrimero,ApellidoSegundo,Contacto,Direccion,CantidadPan")] Proveedore proveedore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,ApellidoPrimero,ApellidoSegundo,Contacto,Direccion,CantidadPan")] Proveedore proveedore)
        {
            if (id != proveedore.Id)
            {
                return NotFound();
